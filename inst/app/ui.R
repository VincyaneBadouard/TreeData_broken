              ...
              column(width = 12,
                     ...
                     box(width = 12,
                         ...
                         fluidRow(column(3, pickerInput("leftTable", "Merge this table", choices = "")),
                                  ...
                                  column(8,  virtualSelectInput("leftKey", div("Using this/these KEY column(s)", br(), em("if you need multiple columns for the merge, the order you select them matters")), choices = "", multiple = T, search = T))),
                         ...
                         fluidRow(column(3, pickerInput("rightTable", "And this table", choices = "")),
                                  ...
                                  column(8,  virtualSelectInput("rightKey", div("Using this/these KEY column(s)", br(), em("if you need multiple columns for the merge, the order you select them matters")), choices = "", multiple = T, search = T))),
                     ...
                     hidden(div(id ="Merge2Div", box(width = 12,
                         ...
                         fluidRow(column(3, pickerInput("leftTable2", "Merge this table", choices = "")),
                                  ...
                                  column(8,  virtualSelectInput("leftKey2", div("Using this/these KEY column(s)", br(), em("if you need multiple columns for the merge, the order you select them matters")), choices = "", multiple = T, search = T))),
                         ...
                         fluidRow(column(3, pickerInput("rightTable2", "And this table", choices = "")),
                                  ...
                                  column(8,  virtualSelectInput("rightKey2", div("Using this/these KEY column(s)", br(), em("if you need multiple columns for the merge, the order you select them matters")), choices = "", multiple = T, search = T))),
                         actionBttn(
                           inputId = "Merge2",
                           label = "Merge tables",
                           style = "material-flat",
