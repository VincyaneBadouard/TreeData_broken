...
# Data
```{r}
PanamaFormated <- read_csv("C:/Users/herrmannV/Dropbox (Smithsonian)/GitHub/VincyaneBadouard/demo/panama-plots_formated.csv")
...
setnames(PanamaFormated, "SubPlot", "Subplot", skip_absent=TRUE)
setnames(PanamaFormated, c("Xutm", "Yutm"), c("XTreeUTM", "YTreeUTM"), skip_absent=TRUE)
...
ScfcCor <- unique(Rslt_bota[ScientificNameCor != ScientificName,
                            list(ScientificName, ScientificNameCor,
                                 ...
                                 BotanicalCorrectionSource, Comment_TreeData)
])
```
