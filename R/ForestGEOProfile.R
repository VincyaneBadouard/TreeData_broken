...
#'   \item{SiteMan}{Value or column name in data set @ForestGeoSubset (SCBI) corresponding to What is your site name ?}
#'   \item{IsLive}{Value or column name in data set @ForestGeoSubset (c("alive", "broken below")) corresponding to Which of your status(es) represent a LIVE tree?}
