...
#'   \item{PlotXutm}{Plot's X UTM coordinates}
#'   \item{PlotYutm}{Plot's Y UTM coordinats}
...
#'   \item{SubPlotXutm}{Subplot's X UTM coordinates}
#'   \item{SubPlotYutm}{Subplot's Y UTM coordinats}
...
#'   \item{Lat}{Tree Latitude}
#'   \item{Lon}{Tree Longitude}
#'   \item{Xutm}{Tree X UTM coordinates}
#'   \item{Yutm}{Tree Y UTM coordinats}
