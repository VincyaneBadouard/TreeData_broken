...
#'   \item{Month}{Value or column name in data set @ForestGeoSubset (none) corresponding to Month of measurement [1-12]}
#'   \item{Day}{Value or column name in data set @ForestGeoSubset (none) corresponding to Day of measurement [1-31]}
...
#'   \item{PlotAreaMan}{Value or column name in data set @ForestGeoSubset () corresponding to What is your plot area in hectare?}
...
#'   \item{utmUnitMan}{Value or column name in data set @ForestGeoSubset (none) corresponding to Tree UTM units}
...
#'   \item{SubPlotAreaMan}{Value or column name in data set @ForestGeoSubset () corresponding to What is your subplot area in hectare?}
...
#'   \item{IdTree}{Value or column name in data set @ForestGeoSubset (treeID) corresponding to Tree ID}
...
#'   \item{MinDBHUnitMan}{Value or column name in data set @ForestGeoSubset (none) corresponding to What is your unit for the column indicating the minimum DBH?}
...
#'   \item{plotUnitMan}{Value or column name in data set @ForestGeoSubset (m) corresponding to Tree XY plot coordinates units}
#'   \item{subplotUnitMan}{Value or column name in data set @ForestGeoSubset (none) corresponding to Tree XY subplot coordinates units}
