...
Data <- data.table(IdTree = c("a", "b", "c", "d"), # 4 ind
                   CensusYear = rep(c(seq(2000,2008, by = 2), 2012, 2014,2016, 2020), 4), # 9 DBH values each (2 years between 2 census)
...
Data[IdTree %in% "a", DBH := ifelse(CensusYear %in% 2014, 19-4, DBH)] 

## 2 shift error with available POM : growth < -2 cm DBH/census with no return to normal

Data[IdTree %in% "c" & CensusYear %in% c(2008:2014), ("POM") := 1]  

Data[IdTree %in% "c" & CensusYear %in% c(2016:2020), ("POM") := 2] 

Data[POM %in% 1, ("DBH") := c(16-4, (16-4)+2, (16-4)+3)] # always 0.5cm/year
Data[POM %in% 2, ("DBH") := c(15-4, (15-4)+2)] # always 0.5cm/year


## 1 shift error without available POM : growth < -2 cm DBH/census with no return to normal
Data[IdTree %in% "d", ("POM") := NA] # no POM
Data[IdTree %in% "d" & CensusYear %in% c(2008:2020), ("DBH") := c(16-4, (16-4)+2, (16-4)+3, (16-4)+4, (16-4)+6)] # same shift
