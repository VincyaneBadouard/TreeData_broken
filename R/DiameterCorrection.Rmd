...
# Data[IdTree %in% "d" & CensusYear %in% c(2008:2020), ("DBH") := c(16-4, (16-4)+2, (16-4)+3, (16-4)+4, (16-4)+6)] # only 1 shift
Data[IdTree %in% "d" & CensusYear %in% c(2008:2014), ("DBH") := c(16-4, (16-4)+2, (16-4)+3)] # 1st shift, always 0.5cm/year
Data[IdTree %in% "d" & CensusYear %in% c(2016:2020), ("DBH") := c(15-4, (15-4)+2)] # 2nd shift, always 0.5cm/year
