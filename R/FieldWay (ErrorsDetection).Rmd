...
Internals:
+ *Bota*
- Detection of the suffix "aceae" in the genus and species columns (it is specific to the family name) -> Comment (+transfer to the Family column?) (sort(unique(data[grep("aceae", data$genus), genus])))
- Special characters
- Typographie
