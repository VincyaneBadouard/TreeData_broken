...
ParacouSubset <- Paracou6C1[Year >= 2016] # 4904 obs
...
```{r}
ParacouSubsetWide <- dcast(ParacouSubset, idTree ~ Year, value.var = "Circ")
OtherCols <- copy(ParacouSubset)
OtherCols[, c("Year", "CensusDate", "CensusDateCertainty","CircCorr", "CorrCode") := NULL]
