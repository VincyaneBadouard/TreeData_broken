...
RecruitmentCorrection <- function(
  ...
  if(!DetectOnly) {
    ...
    NewRows$Diameter_TreeDataCor <- DiameterHistoryCorrected[idx_new_rows, value][m]
...
#
#       DataTree[Year %in% RecruitYear, Comment] <- GenerateComment(DataTree[Year %in% RecruitYear, Comment],
#
#                                   comment = "This DBH is/was the 1st recorded for this tree, according to its annual growth, the census done for this plot and your MinDBH, it should have been recruited earlier")
#
